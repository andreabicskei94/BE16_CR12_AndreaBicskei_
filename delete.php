...
if ($_POST) {
    ...
    ($picture =="hero.jpg")?: unlink("pictures/$picture");
...
<fieldset>
<legend class='h2 mb-3'>Delete request <img class='img-thumbnail rounded-circle' src='pictures/<?php echo $picture ?>' alt="<?php echo $advert_title ?>"></legend>
<h5>You have selected the data below:</h5>
<table class="table w-75 mt-3">
<tr>
            <td><?php echo"This Flat: " . $advert_title?></td>
